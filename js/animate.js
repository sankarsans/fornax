...
tl.from("#banner h3", 0.3,{y:30, opacity:0, ease: Sine.easeIn});
tl.from("#banner p", 1,{x:-100, opacity:0});
...
tl7.from("#section01 #title1", 0.5,{y:10, opacity:0, ease: Sine.easeIn});
tl7.from("#section01 #trigger--title1", 0.3,{y:10, opacity:0, ease: Sine.easeIn});
...
tl8.from("#section02 #title2", 0.5,{y:10, opacity:0, ease: Sine.easeIn});
tl8.from("#section02 #trigger--title2", 0.3,{y:10, opacity:0, ease: Sine.easeIn});
...
tl9.from("#section03 #title3", 0.5,{y:10, opacity:0, ease: Sine.easeIn});
tl9.from("#section03 #trigger--title3", 0.3,{y:10, opacity:0, ease: Sine.easeIn});
